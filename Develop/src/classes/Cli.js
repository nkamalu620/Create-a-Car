...
class Cli {
    ...
    createMotorbike() {
        inquirer_1.default
            ...
            const motorbike = new motorbike(answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), []);
